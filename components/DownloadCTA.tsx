  ...
  return (
    <section className="py-24 px-6 bg-espresso overflow-hidden relative">
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        {/* Headline */}
        <h2 className="text-3xl lg:text-[44px] font-extrabold text-[#FFFAF5] mb-6 tracking-tight leading-[1.12] whitespace-pre-line">
          {t('title')}
        </h2>
        ...
        <a
          ...
          className="inline-flex items-center gap-3.5 bg-[#FFFAF5] text-espresso px-8 py-4.5 rounded-2xl font-bold text-[16px] hover:bg-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-warm-lg"
        >
